 ...
 * @author xiaoymin
 */
@Import(value = {HelioBaseEnumCustomizer.class, Knife4jOpenApiCustomizerOverride.class})
// 需要控制自动配置类加载顺序，去除显式 @EnableKnife4j，改为在 org.springframework.boot.autoconfigure.AutoConfiguration.imports 文件中手动引入
