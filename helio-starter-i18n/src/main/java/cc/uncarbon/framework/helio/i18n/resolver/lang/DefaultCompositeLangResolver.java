...
public class DefaultCompositeLangResolver implements CompositeLangResolver {
    ...
    private static final String LOG_PREFIX = HelioI18nConstant.LOG_PREFIX + "[CompositeLangResolver]";
    ...
    public DefaultCompositeLangResolver(HelioI18nProperties props, List<LangResolver> resolvers) {
        this.props = props;
