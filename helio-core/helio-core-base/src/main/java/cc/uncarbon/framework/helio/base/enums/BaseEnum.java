package cc.uncarbon.framework.helio.base.enums;
...
public interface BaseEnum<T> extends Serializable {
    ...
    default int getValueAsInt() {
        T value = getValue();
        return switch (value) {
            case null -> throw new IllegalArgumentException("enum's value CANNOT be null");
            case Integer i -> i;
            case Long l -> l.intValue();
            case Number n -> n.intValue();
            case String s -> NumberUtil.toBigDecimal(s).intValue();
            default -> throw new HelioFrameworkException("enum's value CANNOT convert to int");
        };
    }
